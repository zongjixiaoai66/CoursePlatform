...
//        }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        // 从数据库查询出所有的数据
        List<ExamPaper> list = examPaperService.list();
        // 在内存操作，写出到浏览器
        ...
        String fileName = URLEncoder.encode("ExamPaper信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<ExamPaper> list = reader.readAll(ExamPaper.class);

        examPaperService.saveBatch(list);
        return Result.success();
    }
