...
<!--    </div>-->
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:9999/log/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
<!--      <el-table-column prop="userid" label="学生id"></el-table-column>-->
      <el-table-column prop="content" label="学习日志"></el-table-column>
    ...
    <div style="padding: 10px 0;margin-top: 100px;">
      <el-pagination
...
export default {
  ...
  methods: {
    load() {
      this.request.get("/log/pageStudent", {
        params: {
    ...
    exp() {
      window.open("http://localhost:9999/log/export")
    },
