<template>
  <div style="margin-bottom: 100px">
    <div style="margin: 20px 0">
      ...
      <span style="font-size: 14px; color: #333; margin-left: 20px">开始时间：{{ exam.time }}</span>
      <span style="font-size: 14px; color: #333; margin-left: 20px">持续时间：{{ exam.duration }} 分</span>
      <span style="font-size: 14px; color: #333; margin-left: 20px">教室：{{ exam.room }}</span>
...
<!--         </div>-->
     ...
     <div style="margin: 20px; text-align: center">
       ...
       <el-button size="medium" type="warning" @click="$router.push('/front/home')">取 消</el-button>
     </div>
   </div>
  </div>
</template>
