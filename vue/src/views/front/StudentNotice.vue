...
<!--          <el-button type="success" @click="handleEdit(scope.row)">编辑 <i class="el-icon-edit"></i></el-button>-->
          <el-button type="success" @click="handleSaveToWord(scope.row)">导出 <i class="el-icon-edit"></i></el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="内容" :visible.sync="dialogFormVisible1" width="40%" :close-on-click-modal="false">
      <el-card>
...
export default {
  ...
  methods: {
    handleSaveToWord(row) {
      ...
      var converted = htmlDocx.asBlob(row.content);
      saveAs(converted, row.name);
    },
    view(content) {
