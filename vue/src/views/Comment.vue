...
<!--      <el-input style="width: 200px" placeholder="请输入" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:9999/comment/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="userid" label="留言用户id"></el-table-column>
      <el-table-column prop="user" label="留言用户"></el-table-column>
      <el-table-column prop="replyUser" label="回复给"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="140px" size="small" style="width: 85%;" :model="form" :rules="rules" ref="ruleForm">
        ...
        <el-form-item prop="userid" label="留言用户id">
          <el-input v-model="form.userid" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="user" label="留言用户">
          <el-input v-model="form.user" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="replyUser" label="回复给">
          <el-input v-model="form.replyUser" autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open("http://localhost:9999/comment/export")
    },
